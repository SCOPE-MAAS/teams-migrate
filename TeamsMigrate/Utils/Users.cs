...
namespace TeamsMigrate.Utils
{
    public class Users
    {
        ...
        internal static string GetOrCreateId(SimpleUser simpleUser, string domain)
        {
            ...
            var httpResponseMessage = Helpers.httpClient.PostAsync(url, new StringContent(createTeamsPutData, Encoding.UTF8, "application/json")).Result;
        ...
        private static string RestoreUser(string userId)
        {
            ...
            var httpResponseMessage = Helpers.httpClient.PostAsync(url, new StringContent("", Encoding.UTF8, "application/json")).Result;
        ...
        internal static void AddOwner(string selectedTeamId, string userId)
        {
            ...
            var httpResponseMessage = Helpers.httpClient.PostAsync(url, new StringContent(addUserToTeamPostData, Encoding.UTF8, "application/json")).Result;
